/*CMD
  command: /distribute_rewardsskip
  help: 
  need_reply: false
  auto_retry_time: 
...
const referrals = RefLib.getRefCount();
    ...
    Bot.sendMessageToChatWithId(userData.user.telegramid,
      "<b>🏆 CHAMPION ALERT!</b> \n\n<b>Congratulations, Superstar! ✨</b>  \n\nYou've officially become our TOP <b>#"+pos+"</b> REFERRER with <b>"+referrals+" Referrals!</b> Your networking game is unmatched – here's your crown: 👑  \n\n<b>🎯 Milestone Unlocked:</b> \n<blockquote>✓ Overlord Tier Achieved  \n✓ <b>"+bonus.toFixed(2)+" "+botc+"</b> Reward Credited  \n✓ Exclusive Leaderboard Position</blockquote>\n\nThe secret of success is to know something nobody else knows.  \n<b>→ You proved it!</b>  \n\n<b>What’s next?</b>    \n<b>🔸 Keep sharing:</b>\n`"+invLink+"`  \n\n<b>We’re rooting for you! 🚀  \n\nTeam "+bot.name+"</b>", { parse_mode: "html" });
