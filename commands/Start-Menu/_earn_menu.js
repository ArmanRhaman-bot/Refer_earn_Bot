...
var inlkey = [[{ text: "💰 My Balance", callback_data: "/account" }],[{ text: "👥 Invite Friends", callback_data: "/invite" },{ text: "🎁 Claim Bonus", callback_data: "/bonus" }],[{ text: "🎮 Game's", callback_data: "/game" },{ text: "🧧 Gift Redeem", callback_data: "/giftBox" }],[{ text: "❓ Support", callback_data: "/support" },{ text: "🏆 Leaderboard", callback_data: "/leaderboard" }],[{ text: "📊 Statistics", callback_data: "/statistics" }]]
if (!request.data) {
Api.sendMessage({
text: txt,
parse_mode: "html",
